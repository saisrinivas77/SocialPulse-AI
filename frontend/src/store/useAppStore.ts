...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  notifications: [
    ...
    {
      id: "n-5",
      title: "TikTok Follower Milestone",
      message: "Your TikTok account just crossed 50,000 followers! Engagement rate: 9.2%.",
      timestamp: "6h ago",
      read: false,
      type: "ai",
    },
    {
      ...
      message: "\"5 Autonomous Workflows for Modern Growth Teams\" published successfully on X.",
      timestamp: "Yesterday",
      read: true,
      type: "system",
    },
    {
      ...
      message: "NovaBrand gained 12K followers this week. SocialPulse AI detected a content gap opportunity.",
      timestamp: "2d ago",
      read: true,
      type: "alert",
    },
  ...
  posts: [
    ...
    {
      id: "post-6",
      title: "How AI Is Replacing Guesswork in Social Media",
      content: "The era of posting blind is over. Here's how SocialPulse AI predicts virality before you publish. 🔮 #SocialAI",
      platform: "X",
      status: "Published",
      scheduledTime: "Aug 4, 2026 at 11:00 AM",
      impressions: "74.5K",
      engagement: "7.1%",
      likes: 2890,
      comments: 310,
    ...
    {
      id: "post-7",
      title: "50K TikTok Followers — What Worked",
      content: "We hit 50K on TikTok using only AI-generated captions and best-time optimization. Here's the full breakdown 🎯",
      platform: "TikTok",
      status: "Published",
      scheduledTime: "Aug 2, 2026 at 07:00 PM",
      impressions: "210K",
      engagement: "9.6%",
      likes: 18200,
      comments: 1420,
    ...
    {
      id: "post-8",
      title: "Enterprise Social OS — Product Launch Reel",
      content: "The SocialPulse AI v3.5 enterprise launch reel is live. 60 seconds. Everything you need to know.",
      platform: "Instagram",
      status: "Published",
      scheduledTime: "Jul 30, 2026 at 06:30 PM",
      impressions: "86.3K",
      engagement: "5.9%",
      likes: 4600,
      comments: 540,
    ...
    {
      id: "post-9",
      title: "State of AI in Marketing 2026 — Free Report",
      content: "We analyzed 5,000+ brands. Here are the 7 biggest AI-driven marketing shifts happening RIGHT NOW. Get the free report.",
      platform: "LinkedIn",
      status: "Scheduled",
      scheduledTime: "Aug 12, 2026 at 09:00 AM",
      impressions: "--",
      engagement: "--",
      likes: 0,
      comments: 0,
  ...
  campaigns: [
    ...
    {
      id: "cmp-5",
      title: "LinkedIn B2B Executive Targeting Drive",
      status: "Completed",
      budget: "$18,000",
      spent: "$17,850",
      roi: "6.1x",
    ...
    {
      id: "cmp-6",
      title: "Summer Instagram UGC Challenge",
      status: "Completed",
      budget: "$8,000",
      spent: "$7,600",
      roi: "2.9x",
